...
public class CrazyRecipes {
    ...
    public static final RecipeSerializer<CanvasShieldApplyingRecipe> CANVAS_SHIELD_APPLYING = new SpecialCraftingRecipe.SpecialRecipeSerializer<>(CanvasShieldApplyingRecipe::new);
    ...
    public static void register() {
        ...
        Registry.register(Registries.RECIPE_SERIALIZER, CrazyPainting.id("canvas_shield_applying"), CANVAS_SHIELD_APPLYING);
    }
}
